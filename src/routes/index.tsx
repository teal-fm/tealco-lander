      ...
      <div className="flex flex-col justify-center items-center flex-1 gap-3 relative">
        <div className="relative">
          <div className="absolute flex justify-center items-center -rotate-2 -z-10 w-full h-full">
            <div className="bg-teal-800 absolute w-9/10 h-8/10 -z-10" />
          </div>
          <h1 className="font-display text-6xl md:text-7xl font-thin w-max h-min">
            Teal Computing Co.
          </h1>
        </div>
        <h3 className="text-xl md:text-2xl font-normal w-max h-min">
